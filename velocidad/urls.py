...
from .views import estado_maquina, nuevo_periodo, generar_anual, actualizar_horario, obtener_anual, guardar_festivos, obtener_codigos, guardar_paradas_agrupadas, leer_paradas_run, obtener_palabraclave, obtener_codigos_resto, crear_turnos, buscar_montajes_of, buscar_descripcion_paradaProdDB, actualizar_parada, eliminar_paradaDB
