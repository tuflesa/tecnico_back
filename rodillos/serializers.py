...
from rodillos.models import Rodillo, Plano, Revision, Seccion, Operacion, Tipo_rodillo, Material, Grupo, Tipo_Plano, Nombres_Parametros, Tipo_Seccion, Parametros_Estandar, Eje, Bancada, Conjunto, Elemento, Celda, Forma, Montaje, Icono, Instancia, Rectificacion, LineaRectificacion, Posicion, Icono_celda, Anotaciones, DestrezasRodillos, Doc_rectificado
...
class DestrezasRodillosSerializer(serializers.ModelSerializer):
    class Meta:
        model = DestrezasRodillos
        fields = ['id', 'nombre']

class DocRectificadoSerializer(serializers.ModelSerializer):
    class Meta:
        model = Doc_rectificado
        fields = '__all__'