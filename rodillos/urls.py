...
router.register('doc_rectificado', DocRectificadoView)
router.register('destrezas_rodillos', DestrezasRodillosViewSet)
...
router.register('icono_celda', Icono_celdaViewSet)
...
router.register('revision_planos_reciente', RevisionPlanosRecienteViewSet, basename='revision_planos_reciente')
